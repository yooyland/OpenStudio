...
final class YooY_Module_Video_Studio extends YooY_Module_Base {
    ...
    public function enqueue_assets(): void {
        ...
        wp_enqueue_script('yoy-video-studio', $base . 'video-studio.js', ['yoy-video-api', 'yoy-reference-assets-panel', 'yoy-studio-simple-mode', 'yoy-studio-handoff'], $this->version(), true);
    }
