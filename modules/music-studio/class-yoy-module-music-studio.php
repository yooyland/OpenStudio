...
final class YooY_Module_Music_Studio extends YooY_Module_Base {
    ...
    public function enqueue_assets(): void {
        ...
        wp_enqueue_script('yoy-music-studio', $base . 'music-studio.js', ['yoy-music-api', 'yoy-reference-assets-panel', 'yoy-studio-simple-mode', 'yoy-studio-handoff'], $this->version(), true);
    }
