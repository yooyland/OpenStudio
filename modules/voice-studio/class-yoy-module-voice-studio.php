...
final class YooY_Module_Voice_Studio extends YooY_Module_Base {
    ...
    public function enqueue_assets(): void {
        ...
        wp_enqueue_script('yoy-voice-studio', $base . 'voice-studio.js', ['yoy-voice-api', 'yoy-reference-assets-panel', 'yoy-studio-simple-mode', 'yoy-studio-handoff'], $this->version(), true);
    }
