        ...
        <main class="yai-main" id="yai-main">
            ...
            <section class="yai-view" data-page="projects">
                <header class="yai-page-head yai-page-head--row">
                    <div>
                        <h1>Projects</h1>
                        <p>Creator Workspace — 프로젝트를 열고 Studio에서 작업하세요.</p>
                    </div>
            ...
            <section class="yai-view" data-page="works"><header class="yai-page-head"><h1>Gallery</h1><p>내 작품 라이브러리 — 생성·Import된 모든 에셋을 한곳에서 관리합니다.</p></header><div id="yai-works"></div></section>
