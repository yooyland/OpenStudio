(function (global) {
  ...
  function promptIntelligencePanelHtml() {
    ...
    var understood = [
      ...
      ['Mood', brief.tone || (state.lastComposerMeta && state.lastComposerMeta.analysis && state.lastComposerMeta.analysis.mood) || '—'],
      ['Emotion', (state.lastComposerMeta && state.lastComposerMeta.analysis && state.lastComposerMeta.analysis.emotion) || brief.tone || '—'],
      ['Style', brief.visual_style || '—'],
      ['Scene', brief.medium || brief.output_format || '—'],
      ['K-Culture', brief.k_culture || '—'],
      ['Meaning', brief.meaning || brief.core_message || '—'],
      ['브랜드', brief.brand_token || '—'],
