(function (global) {
  ...
  Object.assign(Core.gallery || {}, {
    ...
    delistMarketplace: function (id) { return Core.apiDelete('gallery', '/items/' + id + '/marketplace'); },
    community: function (id, data) { return Core.post('gallery', '/items/' + id + '/community', data || {}); },
    unshareCommunity: function (id) { return Core.apiDelete('gallery', '/items/' + id + '/community'); },
    publicRemix: function (galleryId) { return Core.post('gallery', '/public-remix', { gallery_id: galleryId }); },
