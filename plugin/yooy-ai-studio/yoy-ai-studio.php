...
define('YOY_AI_STUDIO_VERSION', '13.4.20');
...
$core_files = [
    ...
    'includes/core/class-yoy-onboarding.php',
    'includes/core/class-yoy-source-authority.php',
...
add_action('plugins_loaded', static function () {
    ...
    if (class_exists('YooY_Onboarding')) {
        YooY_Onboarding::register();
    }
}, 5);
