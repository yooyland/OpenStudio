...
final class YooY_AI_Studio {
    ...
    public function enqueue_assets(): void {
        ...
        wp_enqueue_script(
            'yoy-home-intent',
            YOY_AI_STUDIO_URL . 'assets/js/home-intent.js',
            [],
            YOY_AI_STUDIO_VERSION,
            true
        );
        ...
        wp_enqueue_script(
            ...
            ['yoy-home-dashboard', 'yoy-home-intent'],
            YOY_AI_STUDIO_VERSION,
            true
        );
        ...
        wp_enqueue_style(
            'yoy-creative-canvas',
            YOY_AI_STUDIO_URL . 'assets/css/creative-canvas.css',
            ['yoy-ai-studio'],
            YOY_AI_STUDIO_VERSION
        );
        wp_enqueue_script(
        ...
        wp_enqueue_style(
            'yoy-credits-ui',
            YOY_AI_STUDIO_URL . 'assets/css/credits-ui.css',
            ['yoy-ai-studio'],
            YOY_AI_STUDIO_VERSION
        );
