...
final class YooY_Bridge_Avatar_Provider implements YooY_Avatar_Provider_Interface {
    ...
    public function models(): array {
        return [
            ['id' => $this->default_model, 'name' => $this->label, 'max_duration' => 120],
        ];
    }
    ...
    public function status(string $job_id): array {
        return (new YooY_Mock_Avatar_Provider())->status($job_id);
    }
}
