#!/usr/bin/env python3
"""Upload ONLY YooY Phase 5.5 (12.9.1) integration-audit plugin files via SFTP."""
...
FILES = [
    ...
    ("plugin/yooy-ai-studio/assets/js/creation-templates.js", "assets/js/creation-templates.js"),
    ...
    ("modules/image-studio/includes/class-image-gallery.php", "modules/image-studio/includes/class-image-gallery.php"),
    ("modules/video-studio/includes/class-video-generator.php", "modules/video-studio/includes/class-video-generator.php"),
    ("modules/video-studio/includes/class-video-gallery.php", "modules/video-studio/includes/class-video-gallery.php"),
    ("modules/music-studio/includes/class-music-generator.php", "modules/music-studio/includes/class-music-generator.php"),
    ("modules/music-studio/includes/class-music-gallery.php", "modules/music-studio/includes/class-music-gallery.php"),
    ("modules/voice-studio/includes/class-voice-generator.php", "modules/voice-studio/includes/class-voice-generator.php"),
    ("modules/voice-studio/includes/class-voice-gallery.php", "modules/voice-studio/includes/class-voice-gallery.php"),
    ("modules/avatar-studio/includes/class-avatar-generator.php", "modules/avatar-studio/includes/class-avatar-generator.php"),
    ("modules/avatar-studio/includes/class-avatar-gallery.php", "modules/avatar-studio/includes/class-avatar-gallery.php"),
]
...
def main() -> int:
    ...
    sftp.close()
    transport.close()
    print("Uploaded %d Phase-5.5 files to %s" % (len(uploaded), REMOTE_BASE))
