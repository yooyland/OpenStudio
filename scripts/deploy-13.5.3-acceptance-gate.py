#!/usr/bin/env python3
"""Deploy 13.5.3 acceptance-gate hardening."""
import base64
...
FILES = [
    ...
    ("plugin/yooy-ai-studio/includes/core/class-yoy-image-size-resolver.php", "includes/core/class-yoy-image-size-resolver.php"),
    ...
    ("modules/image-studio/includes/prompt-intelligence/class-image-prompt-fidelity.php", "modules/image-studio/includes/prompt-intelligence/class-image-prompt-fidelity.php"),
...
def main() -> None:
    ...
    print(
        c.exec_command(
            f"cd {REMOTE_ROOT}; php wp-content/uploads/_yoy_opcache_reset.php; rm -f wp-content/uploads/_yoy_opcache_reset.php; grep -n \"13.5.3\" {REMOTE_PLUGIN}yoy-ai-studio.php | head -3",
            timeout=40,
        )[1].read().decode()
    )
    s.close()
