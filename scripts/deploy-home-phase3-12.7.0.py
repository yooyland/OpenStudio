#!/usr/bin/env python3
"""Upload ONLY YooY Phase 3 (12.7.0) plugin files via SFTP."""
...
FILES = [
    ...
    ("plugin/yooy-ai-studio/assets/css/creation-templates.css", "assets/css/creation-templates.css"),
    ("plugin/yooy-ai-studio/assets/js/creation-catalog.js", "assets/js/creation-catalog.js"),
    ("plugin/yooy-ai-studio/assets/js/creation-templates.js", "assets/js/creation-templates.js"),
    ("plugin/yooy-ai-studio/assets/js/home-dashboard-config.js", "assets/js/home-dashboard-config.js"),
...
def main() -> int:
    ...
    sftp.close()
    transport.close()
    print(f"Uploaded {len(uploaded)} Phase-3 files to {REMOTE_BASE}")
