#!/usr/bin/env python3
"""Atomic deploy of 13.6.3 beauty campaign orchestration fix."""
import base64
...
FILES = [
    ...
    ("modules/image-studio/includes/prompt-engine/class-image-emotion-engine.php", "modules/image-studio/includes/prompt-engine/class-image-emotion-engine.php"),
    ...
    ("modules/image-studio/includes/prompt-intelligence/class-studio-creative-brief-builder.php", "modules/image-studio/includes/prompt-intelligence/class-studio-creative-brief-builder.php"),
...
def main() -> None:
    ...
    print(
        c.exec_command(
            ...
            f"grep -n '13.6.3' {REMOTE_PLUGIN}yoy-ai-studio.php | head -3; "
            f"grep -c 'beauty_poster_editorial' {REMOTE_PLUGIN}modules/image-studio/includes/prompt-intelligence/class-studio-intent-analyzer.php; "
            f"grep -c 'refined_beauty' {REMOTE_PLUGIN}modules/image-studio/includes/prompt-engine/class-image-emotion-engine.php; "
            f"grep -c 'compose_beauty_campaign' {REMOTE_PLUGIN}modules/image-studio/includes/prompt-intelligence/class-image-domain-prompt-composer.php",
            timeout=40,
        )[1].read().decode()
    )
    s.close()
