#!/usr/bin/env python3
"""Deploy 13.4.2 Home bottom composer polish via SSH atomic mv."""
...
def main() -> int:
    ...
    verify = c.exec_command(
        ...
        f"grep -c 'border: 2px solid' {REMOTE_REL}/assets/css/home-bottom-composer.css; "
        f"grep -c 'bottom: max(12px' {REMOTE_REL}/assets/css/home-bottom-composer.css",
        timeout=20,
    ...
    print("13.4.2 in html", "13.4.2" in page)

    css = urllib.request.urlopen(
        f"https://yooyland.com/wp-content/plugins/yooy-ai-studio/assets/css/home-bottom-composer.css?ver=13.4.2&cb={cb}",
        timeout=30,
    ).read().decode("utf-8", "replace")
    print("stronger border", "border: 2px solid rgba(212, 175, 55, 0.72)" in css)
    print("lower bottom", "bottom: max(12px" in css)
    print("field contrast", "yai-home-composer__field:focus-within" in css)
    return 0
